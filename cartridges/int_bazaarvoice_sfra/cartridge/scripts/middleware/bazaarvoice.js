 ...
 */
function appendBVData(req, res, next) {
    ...
    if (viewData.product && (BVHelper.isRREnabled() || BVHelper.isQAEnabled())) {
        viewData.bvScout = BVHelper.getBvLoaderUrl();
 ...
 * @param {Function} next - Next call in the middleware chain
 */
function appendBVQuickViewData(req, res, next) {
...
module.exports = {
    appendBVData: appendBVData,
    appendBVQuickViewData: appendBVQuickViewData
};
